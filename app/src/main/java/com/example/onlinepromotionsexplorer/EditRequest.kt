...
class EditRequest : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        autoComplete.onItemClickListener= AdapterView.OnItemClickListener {
            ...
            val Submit1=findViewById<Button>(R.id.reqSubmit)
            Submit1.setOnClickListener {
                Toast.makeText(this,"Submit your details", Toast.LENGTH_SHORT).show()
                val intent4=Intent(this,MyRequestList::class.java)
                startActivity(intent4)

            }
            val Cancel1=findViewById<Button>(R.id.btnreqCancel)
        ...
        btnDatePicker1.setOnClickListener {
            DatePickerDialog(this,datePicker1,myCalendar1.get(Calendar.YEAR),myCalendar1.get(
                Calendar.MONTH),myCalendar1.get(
                Calendar.DAY_OF_MONTH)).show()
        }
    }
